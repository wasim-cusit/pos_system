...
$products = $conn->query('SELECT name, stock FROM products ORDER BY name');
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Stock - Mindgigs POS</title>
        ...
        <main class="col-md-10 ms-sm-auto col-lg-10 px-md-4 main-content">
            <div class="header d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <div class="small">Monitor and manage your stock levels</div>
                </div>
            </div>
